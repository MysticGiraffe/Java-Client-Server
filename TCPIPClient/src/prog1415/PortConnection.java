...
public class PortConnection {
	...
	public static void connectionRefuesed() {
		//Show message dialog
		JOptionPane.showMessageDialog(frame, "Unable to connect to the server. Messaging client will now close.", "Connection Refused", JOptionPane.ERROR_MESSAGE);
		
		frame.setVisible(false);
		
		//Close the application, since application is unable to connect to server
		System.exit(0);
	}
